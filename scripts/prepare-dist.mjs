...
await Promise.all([
  ...
  cp('images/branding/favicon.ico', 'dist/favicon.ico'),
  cp('images/branding/favicon-32.png', 'dist/favicon-32.png'),
  cp('images/branding/favicon-96.png', 'dist/favicon-96.png'),
  cp('images/branding/apple-touch-icon.png', 'dist/apple-touch-icon.png'),
